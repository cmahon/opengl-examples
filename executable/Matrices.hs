-- Source: http://funloop.org/post/2014-03-19-opengl-haskell-3-matrices.html
-- OS X issue: http://stackoverflow.com/questions/19865463/opengl-4-1-under-mavericks
...
initialize = do
	...
	mapM_ GLFW.windowHint
		...
		, GLFW.WindowHint'OpenGLProfile GLFW.OpenGLProfile'Core -- we don't want the old OpenGL
